      ...
      <ul className={styles.LinkList}>
        <li className={styles.LinkItem}>
          <Link
            ...
            target="_blank"
            href={"https://branhamtabernacle.org/" + language + "/home"}
          >
            <img
              src="/logos/BT.png"
        ...
        <li className={styles.LinkItem}>
          <Link
            className={styles.Link}
            target="_blank"
            href={"https://branham.org/en/home"}
          >
            <img
        ...
        <li className={styles.LinkItem}>
          <Link
            className={styles.Link}
            target="_blank"
            href="https://youngfoundations.org/en/home"
          >
            <img src="/logos/YF.png" alt="YF" className={styles.LinkImage} />
        ...
        <li className={styles.LinkItem}>
          <Link
            className={styles.Link}
            target="_blank"
            href="https://themessage.com/en/home"
          >
            <img
        ...
        <li className={styles.LinkItem}>
          <Link
            className={styles.Link}
            href="https://youngfoundations.org/en/creations"
          >
            <img
        ...
        <li className={styles.LinkItem}>
          <Link
            className={styles.Link}
            target="_blank"
            href="https://branhamtabernacle.org/en/streaming"
          >
            <img src="/logos/BT.png" alt="VGR" className={styles.LinkImage} />
        ...
        <li className={styles.LinkItem}>
          <Link
            className={styles.Link}
            target="_blank"
            href="https://branhamtabernacle.org/en/archive"
          >
            <img src="/logos/BT.png" alt="VGR" className={styles.LinkImage} />
